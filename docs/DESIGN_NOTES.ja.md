...
UAC2 として生成される（[USBAudioCard.cpp](../src/USBAudioCard.cpp)）。UAC2 は実質 HS 向けで、`EspUsbHost` の audio
...
`peer/usb_audio` が自動カバー、P4 の UAC2/HS は実機 HS 手動確認でカバーする。1台 P4 loopback は FS 限定で
